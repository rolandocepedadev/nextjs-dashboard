    ...
    <main className="min-h-screen bg-gradient-to-b from-[#f9f9f0] via-[#fefeff] to-[#f0fffc] text-gray-900">
      ...
      <section className="px-6 md:px-12 py-20 text-center">
        ...
        <div className="mt-8 flex flex-col sm:flex-row justify-center items-center gap-4">
          <Link
            href="/login"
            className="rounded-full bg-[#f0ff00] px-6 py-2 text-sm font-semibold text-black hover:bg-black hover:text-white transition"
          >
            Get started
          </Link>
          <Link
      ...
      <section className="max-w-6xl mx-auto px-6 md:px-12 py-12">
        <div className="overflow-hidden rounded-xl border border-gray-200 shadow-md">
          <Image
            src="/hero-desktop.png" // replace with actual dashboard screenshot if you want
